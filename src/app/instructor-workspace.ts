...
import { BroadcastComposerComponent } from './shared/broadcast-composer/broadcast-composer';
import { InstructorInternshipsComponent } from './shared/instructor-internships/instructor-internships';
import { CourseBuilderComponent } from './shared/course-builder/course-builder';

@Component({
  selector: 'app-instructor-workspace',
  imports: [CommonModule, ReactiveFormsModule, MatIconModule, BroadcastComposerComponent, InstructorInternshipsComponent, CourseBuilderComponent],
  templateUrl: './instructor-workspace.html',
})
export class InstructorWorkspace {
  ...
  get editCourseForm(): any { return this.app().editCourseForm; }
  get editingCourseId(): any { return this.app().editingCourseId; }
  get editingCourse(): any { return this.app().editingCourse; }
  get selectedSectionIndex(): any { return this.app().selectedSectionIndex; }
  get showQuizCreator(): any { return this.app().showQuizCreator; }
  get newQuizTitle(): any { return this.app().newQuizTitle; }
  get newQuizPassingScore(): any { return this.app().newQuizPassingScore; }
  get newQuizQuestionsCount(): any { return this.app().newQuizQuestionsCount; }
  ...
  startEditCourse(...args: any[]): any { return this.app().startEditCourse(...args); }
  saveEditCourse(...args: any[]): any { return this.app().saveEditCourse(...args); }
  cancelEditCourse(...args: any[]): any { return this.app().cancelEditCourse(...args); }
  addCourseModule(...args: any[]): any { return this.app().addCourseModule(...args); }
  deleteCourseModule(...args: any[]): any { return this.app().deleteCourseModule(...args); }
  addCourseLesson(...args: any[]): any { return this.app().addCourseLesson(...args); }
  deleteCourseLesson(...args: any[]): any { return this.app().deleteCourseLesson(...args); }
  moveCourseLesson(...args: any[]): any { return this.app().moveCourseLesson(...args); }
  createQuizSubmit(...args: any[]): any { return this.app().createQuizSubmit(...args); }
